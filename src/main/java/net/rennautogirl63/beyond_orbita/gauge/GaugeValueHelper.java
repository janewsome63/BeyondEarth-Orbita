...
import net.rennautogirl63.beyond_orbita.machines.tile.PowerSystemFuelBurnTime;

public class GaugeValueHelper {

    public static final ResourceLocation ENERGY_NAME = new ResourceLocation(BeyondOrbitaMod.MODID, "energy");
    public static final ResourceLocation OXYGEN_NAME = new ResourceLocation(BeyondOrbitaMod.MODID, "oxygen");
    public static final ResourceLocation FLUID_NAME = new ResourceLocation(BeyondOrbitaMod.MODID, "fluid");
    public static final ResourceLocation FUEL_NAME = new ResourceLocation(BeyondOrbitaMod.MODID, "fuel");
    public static final ResourceLocation BURNTIME_NAME = new ResourceLocation(BeyondOrbitaMod.MODID, "burntime");
    public static final ResourceLocation COOKTIME_NAME = new ResourceLocation(BeyondOrbitaMod.MODID, "cooktime");
