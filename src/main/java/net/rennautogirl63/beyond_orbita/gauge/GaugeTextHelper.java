...
public class GaugeTextHelper {
    ...
    public static final ResourceLocation USING_NAME = new ResourceLocation(BeyondOrbitaMod.MODID, "using");
    public static final ResourceLocation USING2_NAME = new ResourceLocation(BeyondOrbitaMod.MODID, "using2");
    public static final ResourceLocation GENERATING_NAME = new ResourceLocation(BeyondOrbitaMod.MODID, "generating");
    public static final ResourceLocation MAXGENERATION_NAME = new ResourceLocation(BeyondOrbitaMod.MODID, "maxgeneration");
    public static final ResourceLocation TOTAL_NAME = new ResourceLocation(BeyondOrbitaMod.MODID, "total");
    public static final ResourceLocation STORED_NAME = new ResourceLocation(BeyondOrbitaMod.MODID, "stored");
    public static final ResourceLocation CAPACITY_NAME = new ResourceLocation(BeyondOrbitaMod.MODID, "capacity");
    public static final ResourceLocation TRANSFER_NAME = new ResourceLocation(BeyondOrbitaMod.MODID, "transfer");
