...
public class GaugeValueSerializer<T extends INBTSerializable<CompoundTag>> {
	...
	static {
		Serializer.addCodec(new ResourceLocation(BeyondOrbitaMod.MODID, "fluidstack"), GaugeValueFluidStack.class);
		Serializer.addCodec(new ResourceLocation(BeyondOrbitaMod.MODID, "simple"), GaugeValueSimple.class);
	}
