package net.rennautogirl63.beyond_orbita.guis.screens.oxygenloader;
...
public class OxygenLoaderGuiWindow extends AbstractContainerScreen<OxygenLoaderGui.GuiContainer> {
    ...
    public static final ResourceLocation texture = new ResourceLocation(BeyondOrbitaMod.MODID, "textures/screens/oxygen_loader.png");
