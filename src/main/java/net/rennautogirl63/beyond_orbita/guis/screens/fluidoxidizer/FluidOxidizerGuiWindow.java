...
@OnlyIn(Dist.CLIENT)
public class FluidOxidizerGuiWindow extends AbstractContainerScreen<FluidOxidizerGui.GuiContainer> {

    public static final ResourceLocation texture = new ResourceLocation(BeyondOrbitaMod.MODID, "textures/screens/fluid_oxidizer.png");
    ...
    public FluidOxidizerGuiWindow(FluidOxidizerGui.GuiContainer container, Inventory inventory, Component text) {
    ...
    public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
        ...
        FluidOxidizerBlockEntity blockEntity = (FluidOxidizerBlockEntity) this.getMenu().getBlockEntity();
    ...
    protected void renderBg(PoseStack ms, float p_97788_, int p_97789_, int p_97790_) {
        ...
        FluidOxidizerBlockEntity blockEntity = this.getMenu().getBlockEntity();
