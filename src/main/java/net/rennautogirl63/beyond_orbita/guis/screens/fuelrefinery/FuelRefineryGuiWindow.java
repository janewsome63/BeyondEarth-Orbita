package net.rennautogirl63.beyond_orbita.guis.screens.fuelrefinery;
...
public class FuelRefineryGuiWindow extends AbstractContainerScreen<FuelRefineryGui.GuiContainer> {
    ...
    public static final ResourceLocation texture = new ResourceLocation(BeyondOrbitaMod.MODID, "textures/screens/fuel_refinery.png");
