package net.rennautogirl63.beyond_orbita.guis.screens.rover;
...
public class RoverGuiWindow extends AbstractContainerScreen<RoverGui.GuiContainer> {
	...
	private static final ResourceLocation texture = new ResourceLocation(BeyondOrbitaMod.MODID, "textures/screens/rover.png");
