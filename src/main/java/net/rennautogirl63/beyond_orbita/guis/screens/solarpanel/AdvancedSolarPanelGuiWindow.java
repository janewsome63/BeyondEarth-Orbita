...
@OnlyIn(Dist.CLIENT)
public class AdvancedSolarPanelGuiWindow extends AbstractContainerScreen<AdvancedSolarPanelGui.GuiContainer> {

    public static final ResourceLocation texture = new ResourceLocation(BeyondOrbitaMod.MODID, "textures/screens/solar_panel.png");

    public AdvancedSolarPanelGuiWindow(AdvancedSolarPanelGui.GuiContainer container, Inventory inventory, Component text) {
    ...
    protected void renderLabels(PoseStack ms, int p_97809_, int p_97810_) {
        ...
        AdvancedSolarPanelBlockEntity blockEntity = this.getMenu().getBlockEntity();
