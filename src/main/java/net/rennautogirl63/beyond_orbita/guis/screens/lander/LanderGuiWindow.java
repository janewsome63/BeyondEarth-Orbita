package net.rennautogirl63.beyond_orbita.guis.screens.lander;
...
public class LanderGuiWindow extends AbstractContainerScreen<LanderGui.GuiContainer> {
    ...
    private static final ResourceLocation texture = new ResourceLocation(BeyondOrbitaMod.MODID, "textures/screens/lander.png");
