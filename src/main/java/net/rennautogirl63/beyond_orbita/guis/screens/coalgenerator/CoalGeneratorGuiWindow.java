package net.rennautogirl63.beyond_orbita.guis.screens.coalgenerator;
...
public class CoalGeneratorGuiWindow extends AbstractContainerScreen<CoalGeneratorGui.GuiContainer> {
    ...
    public static final ResourceLocation TEXTURE = new ResourceLocation(BeyondOrbitaMod.MODID, "textures/screens/coal_generator.png");
