...
public class SpaceSuit {
    ...
    public static class OxygenMask extends ArmorItem {
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return BeyondOrbitaMod.MODID + ":textures/armor/oxygen_mask.png";
        }
    }
    ...
    public static class Suit extends ArmorItem {
        ...
        @Override
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return BeyondOrbitaMod.MODID + ":textures/armor/space_suit.png";
        }
    ...
    public static class Pants extends ArmorItem {
        ...
        @Override
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return BeyondOrbitaMod.MODID + ":textures/armor/space_pants.png";
        }
    }
