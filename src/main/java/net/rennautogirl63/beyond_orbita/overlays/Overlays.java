package net.rennautogirl63.beyond_orbita.overlays;
...
import net.rennautogirl63.beyond_orbita.events.forge.PlanetOverlayEvent;
...
public class Overlays {
    ...
    public static final ResourceLocation TIMER_4_TEXTURE = new ResourceLocation(BeyondOrbitaMod.MODID, "textures/timer/timer4.png");
    public static final ResourceLocation TIMER_5_TEXTURE = new ResourceLocation(BeyondOrbitaMod.MODID, "textures/timer/timer5.png");
    public static final ResourceLocation TIMER_6_TEXTURE = new ResourceLocation(BeyondOrbitaMod.MODID, "textures/timer/timer6.png");
    public static final ResourceLocation TIMER_7_TEXTURE = new ResourceLocation(BeyondOrbitaMod.MODID, "textures/timer/timer7.png");
    public static final ResourceLocation TIMER_8_TEXTURE = new ResourceLocation(BeyondOrbitaMod.MODID, "textures/timer/timer8.png");
