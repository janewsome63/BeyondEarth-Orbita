...
public class ItemsRegistry {
    ...
    public static final RegistryObject<Item> STAINLESS_STEEL_DUST = ITEMS.register("stainless_steel_dust", () -> new Item(new Item.Properties().tab(ItemGroups.tab_normal)));
    public static final RegistryObject<Item> STAINLESS_STEEL_INGOT = ITEMS.register("stainless_steel_ingot", () -> new Item(new Item.Properties().tab(ItemGroups.tab_normal)));
    public static final RegistryObject<Item> STAINLESS_STEEL_NUGGET = ITEMS.register("stainless_steel_nugget", () -> new Item(new Item.Properties().tab(ItemGroups.tab_normal)));
    public static final RegistryObject<Item> STAINLESS_STEEL_PLATE = ITEMS.register("stainless_steel_plate", () -> new Item(new Item.Properties().tab(ItemGroups.tab_normal)));
    public static final RegistryObject<Item> STAINLESS_STEEL_ENGINE = ITEMS.register("stainless_steel_engine", () -> new Item(new Item.Properties().tab(ItemGroups.tab_normal)));
    public static final RegistryObject<Item> STAINLESS_STEEL_TANK = ITEMS.register("stainless_steel_tank", () -> new Item(new Item.Properties().tab(ItemGroups.tab_normal)));
    public static final RegistryObject<Item> STAINLESS_STEEL_HULL = ITEMS.register("stainless_steel_hull", () -> new Item(new Item.Properties().tab(ItemGroups.tab_normal)));
    public static final RegistryObject<BlockItem> STAINLESS_STEEL_BLOCK_ITEM = ITEMS.register("stainless_steel_block", () -> new BlockItem(BlocksRegistry.STAINLESS_STEEL_BLOCK.get(), new Item.Properties().tab(ItemGroups.tab_normal)));
    ...
    public static final RegistryObject<Item> PRIMORDIAL_SHARD = ITEMS.register("primordial_shard", () -> new Item(new Item.Properties().tab(ItemGroups.tab_normal)));
    ...
    public static final RegistryObject<BlockItem> PRIMORDIAL_REMNANT_ITEM = ITEMS.register("primordial_remnant", () -> new BlockItem(BlocksRegistry.PRIMORDIAL_REMNANT.get(), new Item.Properties().tab(ItemGroups.tab_normal)));
    public static final RegistryObject<BlockItem> PRIMORDIAL_BLOCK_ITEM = ITEMS.register("primordial_block", () -> new BlockItem(BlocksRegistry.PRIMORDIAL_BLOCK.get(), new Item.Properties().tab(ItemGroups.tab_normal)));
    ...
    public static final RegistryObject<Item> SULPHUR = ITEMS.register("sulphur", () -> new Item(new Item.Properties().tab(ItemGroups.tab_normal)));
    public static final RegistryObject<Item> SULPHUR_DUST_ITEM = ITEMS.register("sulphur_dust", () -> new Item(new Item.Properties().tab(ItemGroups.tab_normal)));
    ...
    public static final RegistryObject<Item> RAW_CHROMITE = ITEMS.register("raw_chromite", () -> new Item(new Item.Properties().tab(ItemGroups.tab_normal)));
    public static final RegistryObject<Item> CHROMIUM_DUST = ITEMS.register("chromium_dust", () -> new Item(new Item.Properties().tab(ItemGroups.tab_normal)));
    public static final RegistryObject<Item> CHROMIUM_INGOT = ITEMS.register("chromium_ingot", () -> new Item(new Item.Properties().tab(ItemGroups.tab_normal)));
    public static final RegistryObject<Item> CHROMIUM_NUGGET = ITEMS.register("chromium_nugget", () -> new Item(new Item.Properties().tab(ItemGroups.tab_normal)));
    public static final RegistryObject<Item> CHROMIUM_PLATE = ITEMS.register("chromium_plate", () -> new Item(new Item.Properties().tab(ItemGroups.tab_normal)));
    ...
    public static final RegistryObject<BlockItem> RAW_CHROMITE_BLOCK = ITEMS.register("raw_chromite_block", () -> new BlockItem(BlocksRegistry.RAW_CHROMITE_BLOCK.get(), new Item.Properties().tab(ItemGroups.tab_normal)));
    public static final RegistryObject<BlockItem> CHROMIUM_BLOCK_ITEM = ITEMS.register("chromium_block", () -> new BlockItem(BlocksRegistry.CHROMIUM_BLOCK.get(), new Item.Properties().tab(ItemGroups.tab_normal)));
    ...
    public static final RegistryObject<Item> TITANIUM_ENDER_ENGINE = ITEMS.register("titanium_ender_engine", () -> new Item(new Item.Properties().tab(ItemGroups.tab_normal)));
    ...
    public static final RegistryObject<Item> NITROGEN_ICE_SHARD = ITEMS.register("nitrogen_ice_shard", () -> new Item(new Item.Properties().tab(ItemGroups.tab_normal)));
    public static final RegistryObject<Item> CELESTIAL_SHARD = ITEMS.register("celestial_shard", () -> new Item(new Item.Properties().tab(ItemGroups.tab_normal)));
    ...
    public static final RegistryObject<BlockItem> CELESTIAL_FRAGMENT_ITEM = ITEMS.register("celestial_fragment", () -> new BlockItem(BlocksRegistry.CELESTIAL_FRAGMENT.get(), new Item.Properties().tab(ItemGroups.tab_normal)));
