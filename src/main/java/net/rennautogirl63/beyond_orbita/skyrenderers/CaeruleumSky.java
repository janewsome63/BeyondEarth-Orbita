...
public class CaeruleumSky {

    private static final ResourceLocation DIM_RENDER_INFO = new ResourceLocation(BeyondOrbitaMod.MODID, "caeruleum");

    private static final ResourceLocation SUN_TEXTURE = new ResourceLocation(BeyondOrbitaMod.MODID, "textures/sky/orange_sun.png");
    private static final ResourceLocation AVIUM_TEXTURE = new ResourceLocation(BeyondOrbitaMod.MODID, "textures/sky/avium.png");
                ...
                return new ISkyRenderHandler() {
                    ...
                    public void render(int ticks, float p_181412_, PoseStack p_181410_, ClientLevel level, Minecraft minecraft) {
                        ...
                        if (fogtype != FogType.POWDER_SNOW && fogtype != FogType.LAVA) {
                            ...
                            /** Avium */
                            float avium_size = 1.0F;

                            RenderSystem.setShaderTexture(0, AVIUM_TEXTURE);
                            bufferbuilder.begin(VertexFormat.Mode.QUADS, DefaultVertexFormat.POSITION_TEX);
                            bufferbuilder.vertex(matrix4f1, -avium_size, -100.0F, avium_size).uv(0.0F, 0.0F).endVertex();
                            bufferbuilder.vertex(matrix4f1, avium_size, -100.0F, avium_size).uv(1.0F, 0.0F).endVertex();
                            bufferbuilder.vertex(matrix4f1, avium_size, -100.0F, -avium_size).uv(1.0F, 1.0F).endVertex();
                            bufferbuilder.vertex(matrix4f1, -avium_size, -100.0F, -avium_size).uv(0.0F, 1.0F).endVertex();
                            bufferbuilder.end();
                            BufferUploader.end(bufferbuilder);
