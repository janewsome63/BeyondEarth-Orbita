...
public class PetraSky {

    private static final ResourceLocation DIM_RENDER_INFO = new ResourceLocation(BeyondOrbitaMod.MODID, "petra");

    @Nullable
    public static VertexBuffer starBuffer;
    private static final ResourceLocation SUN_TEXTURE = new ResourceLocation(BeyondOrbitaMod.MODID, "textures/sky/no_atmo_red_sun.png");
