package net.rennautogirl63.beyond_orbita.entities.renderer.flag;
...
public class TileEntityHeadModel extends SkullModelBase {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(BeyondOrbitaMod.MODID, "flag"), "main");
