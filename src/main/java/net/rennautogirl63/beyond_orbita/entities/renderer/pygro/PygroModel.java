package net.rennautogirl63.beyond_orbita.entities.renderer.pygro;
...
public class PygroModel<T extends Mob> extends PlayerModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(BeyondOrbitaMod.MODID, "pygro"), "main");
