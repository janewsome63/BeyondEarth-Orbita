package net.rennautogirl63.beyond_orbita.entities.renderer.armors;
...
import net.rennautogirl63.beyond_orbita.rendertypes.TranslucentArmorRenderType;
...
public class SpaceSuitModel {
    ...
    public static class SPACE_SUIT_P2<T extends LivingEntity> extends HumanoidModel<T> {
        ...
        public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(BeyondOrbitaMod.MODID, "space_suit_p2"), "main");
