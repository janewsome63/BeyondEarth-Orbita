...
@OnlyIn(Dist.CLIENT)
public class AATVItemRenderer<T extends AATVEntity> extends BlockEntityWithoutLevelRenderer {
     ...
     * MODEL
     */
    private AATVModel model;

    public AATVItemRenderer(BlockEntityRenderDispatcher p_172550_, EntityModelSet p_172551_) {
    ...
    public void renderByItem(ItemStack p_108830_, ItemTransforms.TransformType p_108831_, PoseStack matrixStackIn, MultiBufferSource buffer, int combinedLight, int p_108835_) {
        ...
        if (this.model == null) {
            this.model = new AATVModel(mc.getEntityModels().bakeLayer(AATVModel.LAYER_LOCATION));
        }
