package net.rennautogirl63.beyond_orbita.entities.renderer.pygrobrute;
...
public class PygroBruteRenderer extends HumanoidMobRenderer<Mob, PygroModel<Mob>> {
    ...
    public static final ResourceLocation TEXTURE = new ResourceLocation(BeyondOrbitaMod.MODID, "textures/entities/pygro_brute.png");
