...
public class AATVEntity extends VehicleEntity {
    ...
    public static final EntityDataAccessor<Integer> FUEL = SynchedEntityData.defineId(AATVEntity.class, EntityDataSerializers.INT);

    public static final EntityDataAccessor<Boolean> FORWARD = SynchedEntityData.defineId(AATVEntity.class, EntityDataSerializers.BOOLEAN);

    public static final int FUEL_BUCKETS = 3;

    public AATVEntity(EntityType type, Level worldIn) {
        super(type, worldIn);
    ...
    public void positionRider(Entity passenger) {
        ...
        passenger.setPos(
                this.getX(),
                this.getY() + this.getPassengersRidingOffset() - 0.85,
                this.getZ()
        );
    }
    ...
    public ItemStack getPickedResult(HitResult target) {
        ItemStack itemStack = new ItemStack(ItemsRegistry.AATV_ITEM.get(), 1);
        itemStack.getOrCreateTag().putInt(BeyondOrbitaMod.MODID + ":fuel", this.entityData.get(FUEL));
            ...
            if (player.isCrouching()) {
                NetworkHooks.openGui((ServerPlayer) player, new MenuProvider() {
                    ...
                    public Component getDisplayName() {
                        return AATVEntity.this.getDisplayName();
                    }

                    @Override
                    public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
                        FriendlyByteBuf packetBuffer = new FriendlyByteBuf(Unpooled.buffer());
                        packetBuffer.writeVarInt(AATVEntity.this.getId());
                        return new AATVGui.GuiContainer(id, inventory, packetBuffer);
                    }
                }, buf -> {
    ...
    public void calculateEntityAnimation(AATVEntity p_21044_, boolean p_21045_) {
