...
import net.rennautogirl63.beyond_orbita.capabilities.fluid.FluidMultiTank;
...
import net.rennautogirl63.beyond_orbita.crafting.FluidIngredient;
import net.rennautogirl63.beyond_orbita.crafting.FluidOxidizingRecipe;
...
public class FluidOxidizerBlockEntity extends AbstractMachineBlockEntity {
    ...
    private FluidOxidizingRecipe cachedRecipe;

    public FluidOxidizerBlockEntity(BlockPos pos, BlockState state) {
        super(BlockEntitiesRegistry.FLUID_OXIDIZER_BLOCK_ENTITY.get(), pos, state);
    ...
    protected FluidTank creatTank(ResourceLocation name) {
        return new FluidTank(this.getInitialTankCapacity(name)) {
            ...
            protected void onContentsChanged() {
                ...
                FluidOxidizerBlockEntity.this.setChanged();
            }
        };
    }
    ...
    protected void createPowerSystems(PowerSystemRegistry map) {
        ...
        map.put(new PowerSystemEnergyCommon(this) {
            ...
            public int getBasePowerForOperation() {
                return FluidOxidizerBlockEntity.this.getBasePowerForOperation();
            }
        });
    }
    ...
    public AbstractContainerMenu createMenu(int id, Inventory inventory) {
        return new FluidOxidizerGui.GuiContainer(id, inventory, this);
    }
    ...
    public boolean consumeIngredients() {
        FluidOxidizingRecipe recipe = this.cacheRecipe();
    ...
    public FluidOxidizingRecipe cacheRecipe() {
    ...
    public BeyondEarthRecipeType<? extends FluidOxidizingRecipe> getRecipeType() {
